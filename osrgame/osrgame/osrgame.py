...
class OSRConsole(App):
    ...
    def set_active_adventure(self, adventure: Adventure = None) -> None:
        ...
        if adventure is None:
            default_adventure = Adventure("Beneath the Mystic Forest")
            default_adventure.introduction = "In the heart of the cursed Mystic Forest, a tale as old as time stirs once again. Legends "
